...
<body class="hold-transition sidebar-mini">
	...
	<form action="" method="post">
		...
		<div class="form-group">
				...
				<input class="form-control py-3" type="text" name="nip" id="nip"
				value="<?= $pgw["nip"]; ?>">
			</div>
	 		<div class="form-group">	
	 		...
	 		<div class="form-group">
				...
				<input  class="form-control py-3" type="text" name="no_telp" id="no_telp"	value="<?= $pgw["no_telp"]; ?>"
				>
			</div>
	 		<div class="form-group">
				<label class="small mb-1" for="alamat">Alamat </label>
				<input class="form-control py-3" type="text" name="alamat" id="alamat"
				value="<?= $pgw["alamat"]; ?>">
			</div>
	 		<div class="form-group">
