...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<a href="tambah.php" class="tambah btn btn-primary">Tambah data pegawai</a> <a href="cetak2.php" target="_blank" class="btn btn-primary">Cetak</a>
	<br><br>
	...
	<table border="1" cellpadding="10", cellspacing="0">
		...
		<tr>
			...
			<td class="aksi">
				...
				<a href="hapus.php? id=<?= $row["id"]; ?>" onclick="return confirm('apakah data ingin dihapus ?');" class="btn btn-danger">hapus</a>
			</td>
		</tr>
		<?php $i++; ?>
		<?php endforeach; ?>
